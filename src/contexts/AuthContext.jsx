 ...
 * - branch_viewer: chỉ Dashboard + Báo cáo, xem tất cả phòng (nhãn UI: "Xem KPI toàn chi nhánh")
 * - department_viewer: chỉ Dashboard + Báo cáo, chỉ phòng mình
 *
 * PERMISSION HELPERS (export):
 * - canAdmin(user): admin
 * - canViewAll(user): admin hoặc branch_viewer
...
export const canViewAll  = (u) => u?.role === 'admin' || u?.role === 'branch_viewer';
